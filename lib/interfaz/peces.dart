  ...
  final List<Map<String, dynamic>> photos = [
    {
      'title': 'Cachama',
      'description':
          'pescado de cabeza grande, presentando la serie opercular bastante desarrollada, lo que implica que al hacer el corte en forma recta, se incluya una porción de la parte comestible',
      'imageUrl':
